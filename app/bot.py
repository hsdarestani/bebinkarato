...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    text = (
        "سلام رفیق 👋\n\n"
        "من Agent برنامه‌ریزی روزانه‌تم. منو و فرم نداریم؛ هر دستوری درباره برنامه‌ت داری عادی بگو یا ویس بده.\n\n"
        "مثلاً:\n"
        "«فردا این سه تا کارو دارم، برام بچینشون»\n"
        "«جلسه رو بنداز ساعت ۵»\n"
        "«کارای کم‌اهمیت امروز رو ببر فردا»\n"
        "«موز خریدن رو حذف کن»\n"
        "«این دوتا رو انجام‌شده بزن»\n"
        "«امروز چی دارم؟»\n"
        "«امروز چیکار کردیم؟»\n\n"
        "هر تغییری بخوام روی برنامه‌ت بدم، اول نشونت می‌دم و تا تأیید نکنی اجراش نمی‌کنم."
    )
